...
public class AdapterEmployee extends RecyclerView.Adapter<AdapterEmployee.EmployeeViewHolder> {
    Context context;
    LayoutInflater layoutInflater;
    ArrayList<Employee> employees = new ArrayList<>();
    public static String TAG = "EmployeeAdapter";

    public AdapterEmployee(Context context, ArrayList<Employee> employees) {
    ...
    public EmployeeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdapterEmployee.EmployeeViewHolder myViewHolder = new AdapterEmployee.EmployeeViewHolder(v);
        return myViewHolder;
    }
